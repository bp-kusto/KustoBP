...
🔹 <ins>Назва властивостей для програмного коду</ins> із контексту процесу перекладена на англійську мову (а не транслітерація назви латинськими літерами), тобто не `NazvaVlastyvostyProcesu`, а `NameOfProcessProperty`
